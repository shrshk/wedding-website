$(document).ready(function () {
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== '94a21ee6e1322ec4bd6fdecf1d4fed76') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbz5uk9-7rBFfjwSbd2oekaiScM4d2MZpIKs6WpoWpqgJmqepPi3XT2N2Fj89rNIBO2-/exec', data)
                .done(function (data) {
                    console.log(data);
